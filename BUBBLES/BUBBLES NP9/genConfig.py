...
parser.add_argument("-L",        type=float, help="Lateral size of the box",  default=300.) 
parser.add_argument("-RNP",      type=float, help="Radius of the NP",         default=4.5) # L > 4*RNP
...
parser.add_argument("-rho_NP", type=float, help="Density of the NP",          default=5.24)
...
parser.add_argument("-C_Prot1", type=float, help="Conc. of Protein 1",        default=0.0)
parser.add_argument("-C_Prot2", type=float, help="Conc. of Protein 2",        default=0.0)
parser.add_argument("-C_Prot3", type=float, help="Conc. of Protein 3",        default=10.0)

''' Number of excess proteins that may be adsorbed to the NP ''' 
parser.add_argument("-Nmin_Prot1", type=float, help="Min Num. Protein 1",     default=0.0)
parser.add_argument("-Nmin_Prot2", type=float, help="Min Num. Protein 2",     default=0.0)
parser.add_argument("-Nmin_Prot3", type=float, help="Min Num. Protein 3",     default=300)
