...
plt.scatter(3/2,3, color= "green")
plt.scatter(6/2,10, color= "green")
plt.scatter(9/2,30, color= "green", label="Simulation")

plt.plot(r1, curva_ex, color="blue", linewidth=1)
plt.scatter(4/2,4, color= "blue")
plt.scatter(5.7/2,12, color= "blue")
plt.scatter(9.4/2,40, color= "blue", label="Experimental")

plt.plot(r1, numero_max, color="purple", linewidth=1)
plt.scatter(3/2,n_max(3/2), color= "purple")
plt.scatter(9/2,n_max(9/2), color= "purple", label="Model (max. distance)")
plt.scatter(6/2, n_max(6/2), color= "purple")
